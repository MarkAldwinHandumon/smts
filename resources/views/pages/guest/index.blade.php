...
<x-app-layout>
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#!">Student's Information</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <div class="col-xl-4">
        <div class="card p-5">
            @if($course->upload)
            <center><img src="{{ asset($course->upload) }}" alt="{{ $course->title }}" class="img-fluid card-img-top" style="width: 50%;"></center>
            @else
            <center><img src="{{ asset('assets/images/tesda.png') }}" alt="user image" class="img-fluid card-img-top" style="width: 50%;"></center>
            @endif
            <div class="card-body">
