                            ...
                            <tr>
                                ...
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu">
                                        <a class="view-action dropdown-item" data-id="{{ $row->id }}" href="{{ route('guest.edit-form', ['id' => $row->user_id]) }}"><i class="feather icon-eye text-info"></i> Preview</a>
                                        ...
                                        @else
                                        <a class="delete-action1 dropdown-item" data-id="{{ $row->user_id }}" href="javascript:void(0)"><i class="feather icon-trash text-danger"></i> Delete</a>
                                        @endif
                                    </div>
                                </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <div class="btn-group">
                                    ...
                                    @if(in_array(strtolower($upload->document_extension), ['jpg', 'jpeg', 'pdf']))
                                        <a class="edit-action dropdown-item" data-id="{{ $upload->id }}" href="javascript:void(0)" onclick="handlePreview(event, '{{ asset('storage/'. $upload->document_path) }}', {{ $upload->id }})"><i class="feather icon-eye text-info"></i> Preview</a>
                                    @endif
                                        <a class="edit-action dropdown-item" data-id="{{ $upload->id }}" href="javascript:void(0)"  onclick="handleDownload(event, {{ $upload->id }})"><i class="feather icon-download text-info"></i> Download</a>
                                        @if( @$upload->status == 'approved')
                                        @else
                                        <a class="delete-action dropdown-item" data-id="{{ $upload->id }}" href="javascript:void(0)"><i class="feather icon-trash text-danger"></i> Delete</a>
                                        @endif
                                    </div>
                                </div>
                                </td>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('upload.create') }}" class="needs-validation" novalidate enctype="multipart/form-data">
                    @csrf
