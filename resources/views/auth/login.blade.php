...
<div class="auth-wrapper">
	<div class="auth-content text-center" style="width: 18%;">
			...
			<div class="row align-items-center text-center">
                ...
                @csrf
					<div class="card-body">
						...
						<p class="mb-2">Forgot password? <a href="{{ route('password.request') }}" class="f-w-400">Reset</a></p>
                        <p class="mb-2">Already have an account? <a href="{{ route('form') }}" class="f-w-400">Signup</a></p>
					</div>
                    </form>
				</div>
